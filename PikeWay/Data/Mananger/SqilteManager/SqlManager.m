...
+ (instancetype)sharedInstance{
    static SqlManager *g_instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        g_instance = [[SqlManager alloc] init];
...
- (NSMutableArray<CreatTable *> *)continueReadingArray{
    if (!_continueReadingArray) {
        _continueReadingArray = [NSMutableArray new];
    }
    return _continueReadingArray;
}
...
- (void)clearCacheWhenLogout{
    ...
    [self.chatGroupArray removeAllObjects];

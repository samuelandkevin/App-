...
//
//@implementation SqlManager (Chat)
//
//#pragma mark - 聊天记录
////建聊天表
...
//        
//        [queue inDatabase:^(FMDatabase *db) {
//            [db yh_excuteDatasWithTable:tableNameChatList(uid) model:[YHChatListModel new] userInfo:userInfo fuzzyUserInfo:fuzzyUserInfo otherSQL:otherSQLDict option:^(NSMutableArray *models) {
//                dispatch_async(dispatch_get_main_queue(), ^{
//                    complete(YES,models);
//                });
//            }];

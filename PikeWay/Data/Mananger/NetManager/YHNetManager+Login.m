...
- (void)getVerifyphoneNum:(NSString *)phoneNum complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathVerifyPhoneExist);
...
- (void)postRegisterWithPhoneNum:(NSString *)phoneNum veriCode:(NSString *)veriCode passwd:(NSString *)passwd complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathRegister);
    
    NSDictionary *dict = @{
                           @"mobile":   phoneNum,
                           @"password":  passwd,
                           @"phoneimei":[OpenUDID value],
                           @"phonetype":[YHUtils phoneType],
                           @"phonesys": [YHUtils phoneSystem],
                           @"version":  [YHUtils appStoreNumber],
                           @"build":    [YHUtils appBulidNumber],
...
- (void)postValidateTokenWithUserInfo:(YHUserInfo *)userInfo complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathValidateToken);
    ...
    if(!uid || !token){
        DErrLog(@"用户id 或 accessToken为nil!");
...
- (void)postLoginWithPhoneNum:(NSString*)phoneNum verifyCode:(NSString *)verifyCode newPasswd:(NSString*)newPasswd complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathForgetPasswd);
    
    NSString *passwdMD5 = [YHUtils md5HexDigest:newPasswd];
...
- (void)postLogoutComplete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathLogout);
...
- (void)postVerifyPhonesAreRegistered:(NSArray *)phoneNums complete:(NetManagerCallback)complete
{
    ...
    NSString *requestUrl = RequestPath(kPathWhetherPhonesAreRegistered);
...
- (void)postVerifyThirdPartyWithUid:(NSString *)uid platform:(PlatformType)platform complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathVerifyThridPartyAccount);
    ...
    NSString *passwdMD5 = [YHUtils md5HexDigest:composeStr];
    NSDictionary *params = @{
                             @"identifier":uid,
...
- (void)postBindPhone:(NSString *)phone platform:(PlatformType)platform thridPartyUid:(NSString *)thridPartyUid verifyCode:(NSString *)verifyCode complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathBindPhoneByThirdPartyAccountLogin);
...
- (void)postThridPartyLoginAndSetPasswd:(NSString *)passwd complete:(NetManagerCallback)complete{
    NSString *requestUrl = RequestPath(kPathThridPartyLoginSetPasswd);
...
- (void)postLoginByWebPage:(NSString *)QRCodeId complete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathLoginByWebPage);
    if(!QRCodeId.length){
...
- (void)postCommitBootLoggingComplete:(NetManagerCallback)complete{
    ...
    NSString *requestUrl = RequestPath(kPathBootLogging);
    ...
    //0-移动，1-联通，2-电信
    int carrierType = 0;
    NSString *carrierName = [YHUtils carrierName];
    ...
    NSDictionary *params = @{
                             @"appId":TaxTaoAppId,
                                 ...
                                 @"phoneSys":[YHUtils phoneSystem],
                                 @"phoneType":[YHUtils phoneType],
                                 @"clientVersion":[YHUtils appStoreNumber],
                                 @"platform":iOSPlatform,
...
- (void)postLoginByTaxQRCode:(NSString *)QRCodeId complete:(NetManagerCallback)complete{
    //kun调试
    NSString *requestUrl = @"http://demo.gtax.cn/pass/sdLogin/confirm_login";
//    NSString *requestUrl = @"http://192.168.3.102:8082/sdLogin/confirm_login";
//
    if(!QRCodeId.length){
        complete(NO,@"QRCodeId is nil");
        return;
    ...
    if (![YHUserInfoManager sharedInstance].userInfo.mobilephone) {
        complete(NO,@"手机号 为nil");
        return;
    }
    NSString *phone = [YHUserInfoManager sharedInstance].userInfo.mobilephone;
    NSDictionary *params = @{
                             @"uuid":QRCodeId,
                             @"phone":phone,
                             @"accessToken":[YHUserInfoManager sharedInstance].userInfo.accessToken

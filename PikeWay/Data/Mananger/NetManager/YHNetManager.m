...
@implementation YHNetManager

+ (YHNetManager*)sharedInstance {
    static YHNetManager  *g_sharedInstance = nil;
    static dispatch_once_t pre = 0;
    dispatch_once(&pre, ^{
        g_sharedInstance = [[YHNetManager alloc] init];
    });

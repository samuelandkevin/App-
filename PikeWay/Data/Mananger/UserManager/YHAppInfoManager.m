...
- (NSString *)userAgent{
    if (!_userAgent) {
        ...
        NSString *aUserAgent = [NSString stringWithFormat:@"%@; ShuiDao /%@",sAgent,[YHUtils appStoreNumber]];
...
//        [[YHNetManager sharedInstance] getPageInfoAboutCanOpenedComplete:^(BOOL success, id obj) {
//            if (success) {
...
//    WeakSelf
//    [[YHNetManager sharedInstance] postFetchReviewStatusComplete:^(BOOL success, id obj) {
//        if(success){
//            NSDictionary *retDict = obj;
//            BOOL isReviewing = [retDict[@"status"] boolValue];
//            weakSelf.reviewPass = isReviewing? NO: YES;
//            complete(weakSelf.reviewPass);
//        }else{
//            weakSelf.reviewPass = NO;
//            complete(NO);
//        }
//    }];
}

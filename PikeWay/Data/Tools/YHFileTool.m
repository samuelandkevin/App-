...
+ (NSString *)getLocalBeatsArtworkCacheDirectory {
    return [[self getAppCacheDirectory] stringByAppendingPathComponent:@"localBeatsArtwork"];
}

+ (NSString *)getAppCacheDirectory {
    NSString* cachesDirectory = [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) objectAtIndex:0];
    return [cachesDirectory stringByAppendingPathComponent:[[NSProcessInfo processInfo] processName]];
}

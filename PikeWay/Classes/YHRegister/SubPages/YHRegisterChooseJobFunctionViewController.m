...
- (void)initUI{
    ...
    self.tbvJobType.backgroundColor = kTbvBGColor;
    self.tbvJobDetail.backgroundColor = kTbvBGColor;
...
- (void)requestIndustryList{
    [[YHNetManager sharedInstance] getIndustryListComplete:^(BOOL success, id obj) {
        if (success) {

...
#import "AppDelegate+TabbarConfig.h"
...
@implementation AppDelegate (TabbarConfig)
...
-(BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    YHTabBarControllerConfig *tabBarControllerConfig = [[YHTabBarControllerConfig alloc] init];
